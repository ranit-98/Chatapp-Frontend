    ...
    return (
        <EmptyStateRoot>
            ...
            <Box sx={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <Typography variant="h4" sx={{ fontWeight: 800, mb: 1, background: extendedPalette.gradients.accent, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                    NexaChat
                </Typography>

                <Typography variant="body1" sx={{ color: 'text.secondary', textAlign: 'center', maxWidth: 360, mb: 4, lineHeight: 1.7 }}>
