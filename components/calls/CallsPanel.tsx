            ...
            <CallItemWrapper key={call.id}>
                ...
                <CallActions>
                    <Tooltip title="Voice Call">
                        <IconButton
                            size="small"
                            sx={{ color: 'text.secondary', '&:hover': { color: 'secondary.main', background: 'rgba(0, 206, 201, 0.1)' } }}
                        >
                    ...
                    <Tooltip title="Video Call">
                        <IconButton
                            size="small"
                            sx={{ color: 'text.secondary', '&:hover': { color: 'primary.main', background: 'rgba(108, 92, 231, 0.1)' } }}
                        >
    ...
    return (
        <CallsRoot>
            ...
            <Box sx={{ px: 2.5, mb: 1 }}>
                ...
                <Box sx={{ display: 'flex', gap: 1.5, mt: 1.5, overflowX: 'auto', pb: 2, '&::-webkit-scrollbar': { display: 'none' } }}>
                    {callLogs.slice(0, 4).map((call, idx) => (
                        <Box key={call.id} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 1, minWidth: 60 }}>
