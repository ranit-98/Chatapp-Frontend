...
export const messages: Record<string, Message[]> = {
  'conv-1': [
    ...
    },
    {
      ...
      senderId: 'user-me',
      content:
        "Going great! I've finished the authentication module. JWT with httpOnly cookies is all set up 🔐",
      type: 'text',
      timestamp: '10:17 AM',
      isRead: true,
    ...
    },
    {
      ...
      senderId: 'user-me',
      content:
        'Yep! Real-time messaging, typing indicators, and even the WebRTC signaling layer is done.',
      type: 'text',
      timestamp: '10:20 AM',
      isRead: true,
      reactions: [
    ...
    },
    {
      ...
      senderId: 'user-1',
      content:
        "I'm impressed! The API docs on Swagger look clean too. Who reviewed the schema design?",
      type: 'text',
      timestamp: '10:22 AM',
      isRead: true,
      reactions: [],
    ...
    },
    {
      ...
      senderId: 'user-me',
      content:
        'Raj and I went through it together. We used Mongoose discriminators for the message types.',
      type: 'text',
      timestamp: '10:24 AM',
      isRead: true,
      reactions: [],
    ...
    },
    {
      ...
      senderId: 'user-1',
      content:
        "Smart approach! I'll start integrating the frontend once Marcus finalizes the UI components.",
      type: 'text',
      timestamp: '10:26 AM',
      isRead: true,
      reactions: [],
    ...
    },
    {
      ...
      senderId: 'user-me',
      content:
        "Perfect. I'll send you the updated Postman collection so you can test the endpoints.",
      type: 'text',
      timestamp: '10:28 AM',
      isRead: true,
      reactions: [{ emoji: '👍', userId: 'user-1', userName: 'Sarah' }],
    ...
    },
    {
      ...
      senderId: 'user-1',
      content:
        'Sounds good! Also, can you check if the file upload endpoint handles voice notes correctly?',
      type: 'text',
      timestamp: '10:30 AM',
      isRead: true,
      reactions: [],
    ...
    },
    {
      ...
      senderId: 'user-me',
      content:
        'Already tested it — supports images, audio files, and voice notes with proper MIME validation ✅',
      type: 'text',
      timestamp: '10:32 AM',
      isRead: true,
      reactions: [],
